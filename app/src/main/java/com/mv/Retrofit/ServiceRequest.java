...
public interface ServiceRequest {
    ...
    Call<ResponseBody> getVillage(@Field("state") String mState, @Field("district") String mDistrict, @Field("taluka") String mTaluka, @Field("entity_type") String entity_type);

    @FormUrlEncoded
    @POST("user/app_get_school")
    Call<ResponseBody> getSchool(@Field("state") String mState, @Field("district") String mDistrict, @Field("taluka") String mTaluka, @Field("village") String mVillage, @Field("entity_type") String entity_type);
