...
import com.sujalamsufalam.databinding.ActivityReportingTemplateBinding;
...
public class ReportingTemplateActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private void getDistrict() {
        ...
        apiService.getDistrict(User.getCurrentUser(ReportingTemplateActivity.this).getMvUser().getState(),"structure").enqueue(new Callback<ResponseBody>() {
            @Override
...
//                            binding.spinnerDistrict.setSelection(mListDistrict.indexOf(User.getCurrentUser(ReportingTemplateActivity.this).getMvUser().getDistrict()));
    ...
    private void getTaluka() {
        ...
        apiService.getTaluka(User.getCurrentUser(ReportingTemplateActivity.this).getMvUser().getState(), mListDistrict.get(mSelectDistrict),"structure").enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                Utills.hideProgressDialog();
                try {
